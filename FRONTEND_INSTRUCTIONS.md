...
- [Pages](#pages)
  ...
  - [Profile](#profile)
  - [Settings](#settings)
  - [Create/Edit Item](#createedit-item)
  - [Item](#item)
      ...
      <div class="col-md-9">
        ...
        <div class="item-preview">
          <div class="item-meta">
            ...
            <div class="info">
              <a href="" class="seller">Eric Simons</a>
        ...
        <div class="item-preview">
          <div class="item-meta">
            ...
            <div class="info">
              <a href="" class="seller">Albert Pai</a>
              <span class="date">January 20th</span>
            </div>
            <button class="btn btn-outline-primary btn-sm pull-xs-right">
    ...
    <div class="row">
      ...
      <div class="col-xs-12 col-md-10 offset-md-1">
        <div class="items-toggle">
          <ul class="nav nav-pills outline-active">
            <li class="nav-item">
              <a class="nav-link active" href="">My Items</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="">Favorited Items</a>
            </li>
          </ul>
        </div>
    ...
    <div class="row">
      ...
      <div class="col-md-10 offset-md-1 col-xs-12">
        <form>
          <fieldset>
            <fieldset class="form-group">
                <input type="text" class="form-control form-control-lg" placeholder="Item Title">
            </fieldset>
            <fieldset class="form-group">
                <input type="text" class="form-control" placeholder="What's this item about?">
            </fieldset>
            <fieldset class="form-group">
                <textarea class="form-control" rows="8" placeholder="Write your item (in markdown)"></textarea>
            </fieldset>
            <fieldset class="form-group">
      ...
      <div class="col-xs-12 col-md-8 offset-md-2">
        ...
        <form class="card comment-form">
          ...
          <div class="card-footer">
            <img src="http://i.imgur.com/Qr71crq.jpg" class="comment-seller-img" />
        ...
        <div class="card">
          ...
          <div class="card-footer">
            ...
            &nbsp;
            <a href="" class="comment-seller">Jacob Schmidt</a>
